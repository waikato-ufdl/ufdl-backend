# Generated by Django 2.2.13 on 2020-08-05 23:12
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('name', 'type', 'default'), name='unique_parameters'),
        ),
        migrations.AddField(
            model_name='node',
            name='current_job',
        ...
        migrations.AddField(
            model_name='jobtemplate',
            name='inputs',
            field=models.ManyToManyField(related_name='job_templates', to='ufdl-core.Input'),
        ),
        migrations.AddField(
            model_name='jobtemplate',
            name='parameters',
            field=models.ManyToManyField(related_name='job_templates', to='ufdl-core.Parameter'),
        ),
        migrations.AddField(
            model_name='jobtemplate',
            name='type',
        ...
        migrations.AddField(
            model_name='job',
            name='node',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='jobs', to='ufdl-core.Node'),
        ),
        migrations.AddField(
            model_name='job',
            name='template',
        ...
        migrations.AddConstraint(
            model_name='input',
            constraint=models.UniqueConstraint(fields=('name', 'type', 'options'), name='unique_inputs'),
        ),
        migrations.AddConstraint(
            model_name='hardware',
        ...
        migrations.AddField(
            ...
            name='base_model',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='dependent_models', to='ufdl-core.Domain'),
        ),
        migrations.AddConstraint(
            model_name='dockerimage',
