...
class MemberHasExecutePermission(MemberPermission):
    """
    Checks if the member has execute permission.
    """
    permissions_set = frozenset((Membership.PERMISSION_EXECUTE,
                                 Membership.PERMISSION_WRITE,
